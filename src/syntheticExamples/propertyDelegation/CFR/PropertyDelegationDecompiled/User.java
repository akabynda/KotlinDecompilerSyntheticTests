...
public final class User {
    ...
    static {
        KProperty[] kPropertyArray = new KProperty[]{Reflection.mutableProperty1(new MutablePropertyReference1Impl(User.class, "name", "getName()Ljava/lang/String;", 0))};
    ...
    public User() {
        ...
        this.name$delegate = new ObservableProperty<String>(initialValue$iv) {
